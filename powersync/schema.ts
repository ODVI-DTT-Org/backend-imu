...
export const tables: Table[] = [
  ...
  new Table({
    ...
    columns: [
      ...
      new Column({ name: 'employee_id', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'first_name', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'last_name', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'phone', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'area_manager_id', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'assistant_area_manager_id', type: ColumnType.TEXT, optional: true }),
  ...
  new Table({
    ...
    columns: [
      ...
      new Column({ name: 'full_address', type: ColumnType.TEXT, optional: true }),
  ...
  new Table({
    ...
    columns: [
      ...
      new Column({ name: 'country', type: ColumnType.TEXT, optional: true }),
  ...
  new Table({
    ...
    columns: [
      ...
      new Column({ name: 'type', type: ColumnType.TEXT }),
      new Column({ name: 'status', type: ColumnType.TEXT }),
      new Column({ name: 'client_id', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'touchpoint_number', type: ColumnType.INTEGER, optional: true }),
      new Column({ name: 'role', type: ColumnType.TEXT }),
      new Column({ name: 'reason', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'notes', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'approved_by', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'approved_at', type: ColumnType.TEXT, optional: true }),
      new Column({ name: 'created_at', type: ColumnType.TEXT }),
      new Column({ name: 'updated_at', type: ColumnType.TEXT }),
    ],
  }),
  ...
  new Table({
    ...
    columns: [
      ...
      new Column({ name: 'role', type: ColumnType.TEXT, optional: true }),
      ...
      new Column({ name: 'created_at', type: ColumnType.TEXT, optional: true }),
    ],
  }),
];
